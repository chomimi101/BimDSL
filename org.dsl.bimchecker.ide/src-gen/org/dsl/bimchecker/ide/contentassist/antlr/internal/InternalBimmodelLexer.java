...
public class InternalBimmodelLexer extends Lexer {
    ...
    public final void mRULE_IFCNAME() throws RecognitionException {
        try {
            ...
            switch (alt3) {
                case 1 :
                    // InternalBimmodel.g:892:17: 'ifc' ( 'wallstandardcase' | 'wall' | 'door' | 'doorstandardcase' | 'window' | 'stair' | 'ramp' | 'covering' | 'furniture' | 'systemfurnitureelement' | 'space' | 'column' | 'railing' | 'roof' | 'curtainwall' | 'buildingstorey' | 'pipesegment' | 'pipefitting' | 'pipevalve' | 'pipecovering' | 'cablepipesegment' | 'cablepipefitting' | 'cablecarriersegment' | 'cablecarrierfitting' | 'ductsegment' | 'ductcovering' | 'DuctFitting' | 'AirTerminal' | 'ductvalve' | 'ductsystem' | 'pipesystem' | 'lightfixture' | 'sanitaryterminal' | 'MechanicalAppliance' | 'ElectricAppliance' | 'Alarm' | 'Footing' | 'Column' | 'structuralframe' | 'ReinforcementMesh' | 'Group' | 'Assembly' | 'ReinforcingMesh' | 'ReinforcingBar' | 'model' | 'Slab' | 'BuildingElementPart' | 'FireSuppressionTerminal' | 'SwitchingDevice' | 'specialappliance' | 'Building' | 'Project' | 'Area' | 'Line' | 'valve' | 'Railing' | 'buildingelementproxy' | 'airterminal' | 'audiovisualappliance' | 'communicationsappliance' | 'electricappliance' | 'firesuppressionterminal' | 'lamp' | 'medicaldevice' | 'outlet' | 'spaceheater' | 'stackterminal' | 'wasteterminal' | 'ceiling' | 'system' | 'openingelement' | 'beam' )
                    {
                    match("ifc"); 

                    // InternalBimmodel.g:892:23: ( 'wallstandardcase' | 'wall' | 'door' | 'doorstandardcase' | 'window' | 'stair' | 'ramp' | 'covering' | 'furniture' | 'systemfurnitureelement' | 'space' | 'column' | 'railing' | 'roof' | 'curtainwall' | 'buildingstorey' | 'pipesegment' | 'pipefitting' | 'pipevalve' | 'pipecovering' | 'cablepipesegment' | 'cablepipefitting' | 'cablecarriersegment' | 'cablecarrierfitting' | 'ductsegment' | 'ductcovering' | 'DuctFitting' | 'AirTerminal' | 'ductvalve' | 'ductsystem' | 'pipesystem' | 'lightfixture' | 'sanitaryterminal' | 'MechanicalAppliance' | 'ElectricAppliance' | 'Alarm' | 'Footing' | 'Column' | 'structuralframe' | 'ReinforcementMesh' | 'Group' | 'Assembly' | 'ReinforcingMesh' | 'ReinforcingBar' | 'model' | 'Slab' | 'BuildingElementPart' | 'FireSuppressionTerminal' | 'SwitchingDevice' | 'specialappliance' | 'Building' | 'Project' | 'Area' | 'Line' | 'valve' | 'Railing' | 'buildingelementproxy' | 'airterminal' | 'audiovisualappliance' | 'communicationsappliance' | 'electricappliance' | 'firesuppressionterminal' | 'lamp' | 'medicaldevice' | 'outlet' | 'spaceheater' | 'stackterminal' | 'wasteterminal' | 'ceiling' | 'system' | 'openingelement' | 'beam' )
                    int alt1=72;
                    alt1 = dfa1.predict(input);
                    switch (alt1) {
                        case 1 :
                            // InternalBimmodel.g:892:24: 'wallstandardcase'
                            {
                            ...
                            break;
                        case 2 :
                            // InternalBimmodel.g:892:43: 'wall'
                            {
                            match("wall"); 
                            ...
                            break;
                        case 3 :
                            // InternalBimmodel.g:892:50: 'door'
                            {
                            match("door"); 
                            ...
                            break;
                        case 4 :
                            // InternalBimmodel.g:892:57: 'doorstandardcase'
                            {
                            ...
                            break;
                        case 5 :
                            // InternalBimmodel.g:892:76: 'window'
                            {
                            match("window"); 
                            ...
                            break;
                        case 6 :
                            // InternalBimmodel.g:892:85: 'stair'
                            {
                            match("stair"); 
                            ...
                            break;
                        case 7 :
                            // InternalBimmodel.g:892:93: 'ramp'
                            {
                            match("ramp"); 
                            ...
                            break;
                        case 8 :
                            // InternalBimmodel.g:892:100: 'covering'
                            {
                            match("covering"); 
                            ...
                            break;
                        case 9 :
                            // InternalBimmodel.g:892:111: 'furniture'
                            {
                            match("furniture"); 
                            ...
                            break;
                        case 10 :
                            // InternalBimmodel.g:892:123: 'systemfurnitureelement'
                            {
                            ...
                            break;
                        case 11 :
                            // InternalBimmodel.g:892:148: 'space'
                            {
                            match("space"); 
                            ...
                            break;
                        case 12 :
                            // InternalBimmodel.g:892:156: 'column'
                            {
                            match("column"); 
                            ...
                            break;
                        case 13 :
                            // InternalBimmodel.g:892:165: 'railing'
                            {
                            match("railing"); 
                            ...
                            break;
                        case 14 :
                            // InternalBimmodel.g:892:175: 'roof'
                            {
                            match("roof"); 
                            ...
                            break;
                        case 15 :
                            // InternalBimmodel.g:892:182: 'curtainwall'
                            {
                            match("curtainwall"); 
                            ...
                            break;
                        case 16 :
                            // InternalBimmodel.g:892:196: 'buildingstorey'
                            {
                            ...
                            break;
                        case 17 :
                            // InternalBimmodel.g:892:213: 'pipesegment'
                            {
                            match("pipesegment"); 
                            ...
                            break;
                        case 18 :
                            // InternalBimmodel.g:892:227: 'pipefitting'
                            {
                            match("pipefitting"); 
                            ...
                            break;
                        case 19 :
                            // InternalBimmodel.g:892:241: 'pipevalve'
                            {
                            match("pipevalve"); 
                            ...
                            break;
                        case 20 :
                            // InternalBimmodel.g:892:253: 'pipecovering'
                            {
                            match("pipecovering"); 
                            ...
                            break;
                        case 21 :
                            // InternalBimmodel.g:892:268: 'cablepipesegment'
                            {
                            ...
                            break;
                        case 22 :
                            // InternalBimmodel.g:892:287: 'cablepipefitting'
                            {
                            ...
                            break;
                        case 23 :
                            // InternalBimmodel.g:892:306: 'cablecarriersegment'
                            {
                            ...
                            break;
                        case 24 :
                            // InternalBimmodel.g:892:328: 'cablecarrierfitting'
                            {
                            ...
                            break;
                        case 25 :
                            // InternalBimmodel.g:892:350: 'ductsegment'
                            {
                            match("ductsegment"); 
                            ...
                            break;
                        case 26 :
                            // InternalBimmodel.g:892:364: 'ductcovering'
                            {
                            match("ductcovering"); 
                            ...
                            break;
                        case 27 :
                            // InternalBimmodel.g:892:379: 'DuctFitting'
                            {
                            match("DuctFitting"); 
                            ...
                            break;
                        case 28 :
                            // InternalBimmodel.g:892:393: 'AirTerminal'
                            {
                            match("AirTerminal"); 
                            ...
                            break;
                        case 29 :
                            // InternalBimmodel.g:892:407: 'ductvalve'
                            {
                            match("ductvalve"); 
                            ...
                            break;
                        case 30 :
                            // InternalBimmodel.g:892:419: 'ductsystem'
                            {
                            match("ductsystem"); 
                            ...
                            break;
                        case 31 :
                            // InternalBimmodel.g:892:432: 'pipesystem'
                            {
                            match("pipesystem"); 
                            ...
                            break;
                        case 32 :
                            // InternalBimmodel.g:892:445: 'lightfixture'
                            {
                            match("lightfixture"); 
                            ...
                            break;
                        case 33 :
                            // InternalBimmodel.g:892:460: 'sanitaryterminal'
                            {
                            ...
                            break;
                        case 34 :
                            // InternalBimmodel.g:892:479: 'MechanicalAppliance'
                            {
                            ...
                            break;
                        case 35 :
                            // InternalBimmodel.g:892:501: 'ElectricAppliance'
                            {
                            ...
                            break;
                        case 36 :
                            // InternalBimmodel.g:892:521: 'Alarm'
                            {
                            match("Alarm"); 
                            ...
                            break;
                        case 37 :
                            // InternalBimmodel.g:892:529: 'Footing'
                            {
                            match("Footing"); 
                            ...
                            break;
                        case 38 :
                            // InternalBimmodel.g:892:539: 'Column'
                            {
                            match("Column"); 
                            ...
                            break;
                        case 39 :
                            // InternalBimmodel.g:892:548: 'structuralframe'
                            {
                            ...
                            break;
                        case 40 :
                            // InternalBimmodel.g:892:566: 'ReinforcementMesh'
                            {
                            ...
                            break;
                        case 41 :
                            // InternalBimmodel.g:892:586: 'Group'
                            {
                            match("Group"); 
                            ...
                            break;
                        case 42 :
                            // InternalBimmodel.g:892:594: 'Assembly'
                            {
                            match("Assembly"); 
                            ...
                            break;
                        case 43 :
                            // InternalBimmodel.g:892:605: 'ReinforcingMesh'
                            {
                            ...
                            break;
                        case 44 :
                            // InternalBimmodel.g:892:623: 'ReinforcingBar'
                            {
                            ...
                            break;
                        case 45 :
                            // InternalBimmodel.g:892:640: 'model'
                            {
                            match("model"); 
                            ...
                            break;
                        case 46 :
                            // InternalBimmodel.g:892:648: 'Slab'
                            {
                            match("Slab"); 
                            ...
                            break;
                        case 47 :
                            // InternalBimmodel.g:892:655: 'BuildingElementPart'
                            {
                            ...
                            break;
                        case 48 :
                            // InternalBimmodel.g:892:677: 'FireSuppressionTerminal'
                            {
                            ...
                            break;
                        case 49 :
                            // InternalBimmodel.g:892:703: 'SwitchingDevice'
                            {
                            ...
                            break;
                        case 50 :
                            // InternalBimmodel.g:892:721: 'specialappliance'
                            {
                            ...
                            break;
                        case 51 :
                            // InternalBimmodel.g:892:740: 'Building'
                            {
                            match("Building"); 
                            ...
                            break;
                        case 52 :
                            // InternalBimmodel.g:892:751: 'Project'
                            {
                            match("Project"); 
                            ...
                            break;
                        case 53 :
                            // InternalBimmodel.g:892:761: 'Area'
                            {
                            match("Area"); 
                            ...
                            break;
                        case 54 :
                            // InternalBimmodel.g:892:768: 'Line'
                            {
                            match("Line"); 
                            ...
                            break;
                        case 55 :
                            // InternalBimmodel.g:892:775: 'valve'
                            {
                            match("valve"); 
                            ...
                            break;
                        case 56 :
                            // InternalBimmodel.g:892:783: 'Railing'
                            {
                            match("Railing"); 
                            ...
                            break;
                        case 57 :
                            // InternalBimmodel.g:892:793: 'buildingelementproxy'
                            {
                            ...
                            break;
                        case 58 :
                            // InternalBimmodel.g:892:816: 'airterminal'
                            {
                            match("airterminal"); 
                            ...
                            break;
                        case 59 :
                            // InternalBimmodel.g:892:830: 'audiovisualappliance'
                            {
                            ...
                            break;
                        case 60 :
                            // InternalBimmodel.g:892:853: 'communicationsappliance'
                            {
                            ...
                            break;
                        case 61 :
                            // InternalBimmodel.g:892:879: 'electricappliance'
                            {
                            match("electricappliance"); 
                            ...
                            break;
                        case 62 :
                            // InternalBimmodel.g:892:899: 'firesuppressionterminal'
                            {
                            match("firesuppressionterminal"); 
                            ...
                            break;
                        case 63 :
                            // InternalBimmodel.g:892:925: 'lamp'
                            {
                            match("lamp"); 
                            ...
                            break;
                        case 64 :
                            // InternalBimmodel.g:892:932: 'medicaldevice'
                            {
                            match("medicaldevice"); 
                            ...
                            break;
                        case 65 :
                            // InternalBimmodel.g:892:948: 'outlet'
                            {
                            match("outlet"); 
                            ...
                            break;
                        case 66 :
                            // InternalBimmodel.g:892:957: 'spaceheater'
                            {
                            match("spaceheater"); 
                            ...
                            break;
                        case 67 :
                            // InternalBimmodel.g:892:971: 'stackterminal'
                            {
                            match("stackterminal"); 
                            ...
                            break;
                        case 68 :
                            // InternalBimmodel.g:892:987: 'wasteterminal'
                            {
                            match("wasteterminal"); 
                            ...
                            break;
                        case 69 :
                            // InternalBimmodel.g:892:1003: 'ceiling'
                            {
                            match("ceiling"); 
                            ...
                            break;
                        case 70 :
                            // InternalBimmodel.g:892:1013: 'system'
                            {
                            match("system"); 
                            ...
                            break;
                        case 71 :
                            // InternalBimmodel.g:892:1022: 'openingelement'
                            {
                            ...
                            break;
                        case 72 :
                            // InternalBimmodel.g:892:1039: 'beam'
                            {
                            match("beam"); 
                    ...
                    break;
                case 2 :
                    // InternalBimmodel.g:892:1047: 'Ifc' ( 'SwitchingDevice' | 'FireSuppressionTerminal' | 'Alarm' | 'ElectricAppliance' )
                    {
                    match("Ifc"); 

                    // InternalBimmodel.g:892:1053: ( 'SwitchingDevice' | 'FireSuppressionTerminal' | 'Alarm' | 'ElectricAppliance' )
                    int alt2=4;
                    switch ( input.LA(1) ) {
                    case 'S':
                        {
                    ...
                    switch (alt2) {
                        case 1 :
                            // InternalBimmodel.g:892:1054: 'SwitchingDevice'
                            {
                            match("SwitchingDevice"); 
                            ...
                            break;
                        case 2 :
                            // InternalBimmodel.g:892:1072: 'FireSuppressionTerminal'
                            {
                            match("FireSuppressionTerminal"); 
                            ...
                            break;
                        case 3 :
                            // InternalBimmodel.g:892:1098: 'Alarm'
                            {
                            match("Alarm"); 
                            ...
                            break;
                        case 4 :
                            // InternalBimmodel.g:892:1106: 'ElectricAppliance'
                            {
                            match("ElectricAppliance"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:894:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalBimmodel.g:894:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalBimmodel.g:894:11: ( '^' )?
            int alt4=2;
            ...
            // InternalBimmodel.g:894:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:896:10: ( ( '0' .. '9' )+ )
            // InternalBimmodel.g:896:12: ( '0' .. '9' )+
            {
            // InternalBimmodel.g:896:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:898:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalBimmodel.g:898:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalBimmodel.g:898:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalBimmodel.g:898:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalBimmodel.g:898:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalBimmodel.g:898:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalBimmodel.g:898:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:900:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalBimmodel.g:900:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalBimmodel.g:900:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:902:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBimmodel.g:902:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalBimmodel.g:902:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:904:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalBimmodel.g:904:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalBimmodel.g:904:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBimmodel.g:906:16: ( . )
            // InternalBimmodel.g:906:18: .
            {
            matchAny(); 
    ...
    class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "892:23: ( 'wallstandardcase' | 'wall' | 'door' | 'doorstandardcase' | 'window' | 'stair' | 'ramp' | 'covering' | 'furniture' | 'systemfurnitureelement' | 'space' | 'column' | 'railing' | 'roof' | 'curtainwall' | 'buildingstorey' | 'pipesegment' | 'pipefitting' | 'pipevalve' | 'pipecovering' | 'cablepipesegment' | 'cablepipefitting' | 'cablecarriersegment' | 'cablecarrierfitting' | 'ductsegment' | 'ductcovering' | 'DuctFitting' | 'AirTerminal' | 'ductvalve' | 'ductsystem' | 'pipesystem' | 'lightfixture' | 'sanitaryterminal' | 'MechanicalAppliance' | 'ElectricAppliance' | 'Alarm' | 'Footing' | 'Column' | 'structuralframe' | 'ReinforcementMesh' | 'Group' | 'Assembly' | 'ReinforcingMesh' | 'ReinforcingBar' | 'model' | 'Slab' | 'BuildingElementPart' | 'FireSuppressionTerminal' | 'SwitchingDevice' | 'specialappliance' | 'Building' | 'Project' | 'Area' | 'Line' | 'valve' | 'Railing' | 'buildingelementproxy' | 'airterminal' | 'audiovisualappliance' | 'communicationsappliance' | 'electricappliance' | 'firesuppressionterminal' | 'lamp' | 'medicaldevice' | 'outlet' | 'spaceheater' | 'stackterminal' | 'wasteterminal' | 'ceiling' | 'system' | 'openingelement' | 'beam' )";
        }
    }
